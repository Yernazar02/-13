...
public class dom13 {
    ...
    static class LibraryRepository {
        ...
        public boolean removeBook(int bookId) { return books.remove(bookId) != null; }
        ...
        public boolean removeBranch(int branchId) { return branches.remove(branchId) != null; }
        ...
        public long totalIssuedBooks() { return reservations.size(); }
    ...
    static class LibraryService {
        ...
        public Reservation reserveBook(Reader reader, int bookId, int branchId) {
            ...
            if (book == null) { System.out.println("Book not found id=" + bookId); return null; }
            if (branch == null) { System.out.println("Branch not found id=" + branchId); return null; }
            if (book.getTotalCopies() <= 0) { System.out.println("No copies available for book " + book.getTitle()); return null; }
        ...
        public void showActiveReservations(Librarian librarian) {
            ...
            for (Reservation r : repo.getActiveReservations()) System.out.println("  " + r);
        }
    ...
    static class TicketVendingMachine {
        ...
        void resetSelection() { selectedTicket = null; insertedAmount = 0.0; }
        ...
        void returnChange() {
            ...
            if (change > 0) System.out.printf("Returning change: %.2f\n", change);
        }
    }
    ...
    static class WaitingForMoneyState implements VendingState {
        ...
        public void insertMoney(double amount) {
            ...
            if (machine.getInsertedAmount() >= price) machine.setState(machine.getMoneyReceivedState());
        }

        @Override
        public void cancel() {
            System.out.println("Transaction canceled by user (while waiting for money).");
    ...
    static class MoneyReceivedState implements VendingState {
        ...
        @Override public void selectTicket(String ticketType) { System.out.println("Can't change selection after full payment."); }
        ...
        @Override
        public void cancel() {
            System.out.println("Transaction canceled after receiving money.");
    ...
    static class TicketDispensedState implements VendingState {
        ...
        @Override public void selectTicket(String ticketType) { System.out.println("Please wait."); }
        @Override public void insertMoney(double amount) { System.out.println("Please wait."); }
    ...
    public static void main(String[] args) {
        ...
        Reservation r3 = service.reserveBook(reader, b2.getId(), br1.getId());
        ...
        for (int i = 0; i < 98; i++) machine.selectTicketType("Standard");
